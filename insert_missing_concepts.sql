...
VALUES (2001, 1001, 'Artemether-Lumefantrine', 'en', 'FULLY_SPECIFIED', 1, NOW(), '161350AAAAAAAAAAAAAAAAAAAAAAAAAAAAB')
ON DUPLICATE KEY UPDATE name=name;

INSERT INTO concept_name (concept_name_id, concept_id, name, locale, concept_name_type, creator, date_created, uuid)
VALUES (2002, 1001, 'AL', 'en', 'SHORT', 1, NOW(), '161350AAAAAAAAAAAAAAAAAAAAAAAAAAAAC')
ON DUPLICATE KEY UPDATE name=name;

INSERT INTO concept_description (concept_description_id, concept_id, description, locale, creator, date_created, uuid)
VALUES (3001, 1001, 'Artemether-Lumefantrine combination (ACT) for uncomplicated malaria', 'en', 1, NOW(), '161350AAAAAAAAAAAAAAAAAAAAAAAAAAAAD')
...
INSERT INTO concept_name (concept_name_id, concept_id, name, locale, concept_name_type, creator, date_created, uuid)
VALUES (2003, 1002, 'Malaria danger signs', 'en', 'FULLY_SPECIFIED', 1, NOW(), '162568AAAAAAAAAAAAAAAAAAAAAAAAAAAAB')
ON DUPLICATE KEY UPDATE name=name;

INSERT INTO concept_name (concept_name_id, concept_id, name, locale, concept_name_type, creator, date_created, uuid)
VALUES (2004, 1002, 'Danger signs', 'en', 'SHORT', 1, NOW(), '162568AAAAAAAAAAAAAAAAAAAAAAAAAAAAC')
ON DUPLICATE KEY UPDATE name=name;

INSERT INTO concept_description (concept_description_id, concept_id, description, locale, creator, date_created, uuid)
VALUES (3002, 1002, 'Danger signs observed during malaria consultation (multi-select)', 'en', 1, NOW(), '162568AAAAAAAAAAAAAAAAAAAAAAAAAAAAD')
ON DUPLICATE KEY UPDATE description=description;
...
INSERT INTO concept_name (concept_name_id, concept_id, name, locale, concept_name_type, creator, date_created, uuid)
VALUES (2005, 1003, 'Malaria classification', 'en', 'FULLY_SPECIFIED', 1, NOW(), '160108AAAAAAAAAAAAAAAAAAAAAAAAAAAAB')
ON DUPLICATE KEY UPDATE name=name;

INSERT INTO concept_name (concept_name_id, concept_id, name, locale, concept_name_type, creator, date_created, uuid)
VALUES (2006, 1003, 'Classification', 'en', 'SHORT', 1, NOW(), '160108AAAAAAAAAAAAAAAAAAAAAAAAAAAAC')
ON DUPLICATE KEY UPDATE name=name;

INSERT INTO concept_description (concept_description_id, concept_id, description, locale, creator, date_created, uuid)
VALUES (3003, 1003, 'Final malaria classification (uncomplicated vs severe)', 'en', 1, NOW(), '160108AAAAAAAAAAAAAAAAAAAAAAAAAAAAD')
ON DUPLICATE KEY UPDATE description=description;
